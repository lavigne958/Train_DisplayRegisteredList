...
/**
 * @brief MainWindow::on_header_dialog_validate triggered when user clicks on "OK" on the secondary Dialog
...
/**
 * @brief MainWindow::on_header_dialog_close triggered when the dialog window closes
